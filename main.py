...
# 1. Load Dataset
dataset_path = 'xulyanh/PhungQuangTuan_Bai3/dataset'  # Thư mục chứa dữ liệu

flower_path = os.path.join(dataset_path, 'f')  # Thư mục hoa
animal_path = os.path.join(dataset_path, 'a')  # Thư mục động vật
